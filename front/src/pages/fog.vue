...
<template>
  <section class="pt-30">
    <div class="bg-[url(/photos/drywash.jpg)] h-[550px] bg-cover text-white text-xl font-sans flex flex-col justify-between py-8">
      <div class="flex gap-4 items-center text-3x justify-around px-8">
        <img src="/icons/wash.svg" alt="shield" class="h-20">
        <h1>Сухой туман</h1>
      </div>
      <p class="px-8 flex">Эффективное устранение неприятных запахов в салоне. Дезинфекция и освежение воздуха без использования химии.</p>
    </div>
  </section>
  ...
  <section class="pt-12 px-8">
    ...
    <img src="/photos/drywash.jpg" alt="fogwash">
  </section>
