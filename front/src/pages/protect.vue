...
<template>
  <section class="pt-30">
    <div class="bg-[url(/photos/protect.jpg)] h-[550px] bg-cover text-white text-xl font-sans flex flex-col justify-between py-8">
      <div class="flex gap-4 items-center text-3x justify-around px-8">
        <img src="/icons/polish.svg" alt="shield" class="h-20">
        <h1>Защитная оклейка</h1>
      </div>
      <p class="px-8 flex">Надежная защита кузова от сколов и царапин. Сохраняем идеальное состояние лакокрасочного покрытия.</p>
    </div>
  </section>
  ...
  <section class="pt-12 px-8">
    ...
    <ImgComparisonSlider>
      <img
        ...
        src="/photos/before_after/protect.png"
      />
      <img
        slot="second"
        class="w-full h-full object-cover"
        src="/photos/before_after/protect2.png"
      />
    </ImgComparisonSlider>
  </section>
