...
<template>
  <section class="pt-30">
    <div class="bg-[url(/photos/chrome.jpg)] h-[550px] bg-cover text-white text-xl font-sans flex flex-col justify-between py-8">
      <div class="flex gap-4 items-center text-3x justify-around px-8">
        <img src="/icons/chrome.svg" alt="chrome" class="h-20">
        <h1>Антихром</h1>
      </div>
      <p class="px-8 flex">Профессиональное затемнение хромированных деталей. Преображаем решётку радиатора, молдинги и эмблемы, создавая целостный и выразительный образ автомобиля.</p>
    </div>
  </section>
  ...
  <section class="pt-12 px-8 flex flex-col items-center">
    ...
    <ImgComparisonSlider>
      <img
        ...
        src="/photos/before_after/anti.png"
      />
      <img
        slot="second"
        class="w-full h-full object-cover"
        src="/photos/before_after/anti2.png"
      />
    </ImgComparisonSlider>
  </section>
