...
<template>
  <section class="pt-30">
    <div class="bg-[url(/photos/detailing.jpg)] h-[550px] bg-cover text-white text-xl font-sans flex flex-col justify-between py-8">
      <div class="flex gap-4 items-center text-3x justify-around px-8">
        <img src="/icons/chem.svg" alt="chemistry" class="h-20">
        <h1>Химчистка салона</h1>
      </div>
      <p class="px-8 flex">Комплексное очищение всех поверхностей от любых загрязнений. Восстанавливаем чистоту и свежесть как в новом автомобиле.</p>
    </div>
  </section>
  ...
  <section class="pt-12 px-8">
    ...
    <ImgComparisonSlider>
      <img
        ...
        src="/photos/before_after/chem.png"
      />
      <img
        slot="second"
        class="w-full h-full object-cover"
        src="/photos/before_after/chem2.png"
      />
    </ImgComparisonSlider>
  </section>
